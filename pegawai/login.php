...
<body>
        ...
        <div class="container" style="margin-top:7rem;">
            ...
            <div class="col-4 offset-1 border-right border-left rounded p-4 mb-5">
                <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input required="yes" type="text" class="form-control" name='username' placeholder="Email">
                        </div>
                        <div class="form-group">
                            <input required="yes" type="password" name='password' class="form-control" placeholder="Password">
                        </div>
    ...
    <nav class="nav bg-2 shadow p-3 fixed-top" id="navbar-top">
                ...
                <a  id="produk" href="../index.php" class="text-light font-weight-bold text-center col" style="text-decoration: none; font-size: 26px;"><i class="fas fa-briefcase"></i></i> SIMAGANG</a>
