...
<table class="table table-striped table-bordered text-center" >
    <thead class="thead-dark">
        <tr>
            <th>No<th>ID Daftar<th>Status<th>Nama Ketua<th>E-mail<th>Jurusan<th>Instansi<th>Detail<th>Hapus
        </tr>
    </thead>
    <tbody>
              <?php
...
function hapus(id_daftar){
    ...
    if(jawab==true){
        document.location="proses_hapuskel.php?id_daftar="+id_daftar;
    }
}
</script>
