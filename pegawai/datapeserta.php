...
<table class="table table-striped table-bordered text-center" >
    <thead class="thead-dark">
        <tr>
            <th>No<th>ID Daftar<th>Nama<th>Kelamin<th>Alamat<th>E-mail<th>No hp<th>Jurusan<th>Identitas<th>Hapus
        </tr>
    </thead>
    <tbody>
              <?php
        ...
        <tr>
            ...
            <td style="text-align: center;"><button class="btn badge-info" onclick="hapus(<?php echo"'$data2[id_peserta]'";  ?>)">Hapus</button></td>
        </tr>
        <?php
        $no++;
        } 
