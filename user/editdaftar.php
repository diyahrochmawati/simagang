...
$temp = explode(".", $_FILES["proposal"]["name"]);//untuk mengambil nama file gambarnya saja tanpa format gambarnya
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["proposal"]["tmp_name"], $target_file)) {
        $nama_file=($_FILES["proposal"]["name"]);
        echo "<div class='alert alert-success position-relative' style='top: 20px'>Upload File Proposal Sukses!</div>";
        mysqli_query($connection,"update pendaftaran set (proposal) VALUES ('$nama_file'");
    } else {
    }
}
}
...
if ($_FILES["kartu_identitas"]["size"] > 2000000) {
   echo "<script>alert('Upload ulang ktp ! Ukuran file terlalu besar Max 2mb'); window.location='index.php?page=editdaftar';</script>";
    $uploadOk = 0;
}
// Allow certain file formats
                ...
                <div>
                    <form method="POST" action="" enctype="multipart/form-data" onsubmit="return validasi()" name="pendaftaran">
                        <div class="form-group">
                            <label for="">Upload Proposal <strong>Harus (.pdf)</strong>: </label>
                            <input type="file" name="proposal" id="proposal" class="form-control" value="<?php echo $hasil['proposal'];?>"/>
                        </div>
                        
                        <div class="form-group">
                            <label for="">Kartu Identitas <strong>Harus (.jpg)</strong>: </label>
                            <input type="file" name="kartu_identitas" id="kartu_identitas" class="form-control" value="<?php echo $hasil['kartu_identitas'];?>"/>
                        </div>
                        
                        <div class="form-group">
                            <label for="jml_peserta">Jumlah Peserta :</label>
                            <input type="text" id="jml_peserta" name="jml_peserta" class="form-control" placeholder="Jumlah Peserta" value="<?php echo $hasil['jml_peserta'];?>" >
                            <div class="text-danger" id="jml_peserta_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="no_ktp">No KTP/NIM/NIS :</label>
                            <input type="text" id="no_ktp" name="no_ktp" class="form-control" placeholder="No KTP/NIM/NIS" value="<?php echo $hasil['no_ktp'];?>" >
                            <div class="text-danger" id="no_ktp_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="nama_ketua">Nama Ketua :</label>
                            <input type="text" id="nama_ketua" name="nama_ketua" class="form-control" placeholder="Nama Ketua" value="<?php echo $hasil['nama_ketua'];?>" >
                            <div class="text-danger" id="nama_ketua_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="tempat_lahir">Tempat Lahir :</label>
                            <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" value="<?php echo $hasil['tempat_lahir'];?>" >
                            <div class="text-danger" id="tempat_lahir_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="tanggal_lahir">Tanggal Lahir :</label>
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?php echo $hasil['tanggal_lahir'];?>" >
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" rows="5" cols="40" class="form-control"><?php echo $hasil['alamat'];?> </textarea>
                            <div class="text-danger" id="alamat_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="email">E-mail :</label>
                            <input type="email" name="email" id="email" class="form-control" placeholder="Email" value="<?php echo $hasil['email'];?>" >
                            <div class="text-danger" id="email_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="no_tlp">Nomer HP :</label>
                            <input type="text" name="no_tlp" id="no_tlp" class="form-control" placeholder="Nomer Handphone" value="<?php echo $hasil['no_tlp'];?>" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="instansi" id="instansi" class="form-control" placeholder="Sekolah/Universitas" value="<?php echo $hasil['instansi'];?>" >
                            <div class="text-danger" id="instansi_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="jurusan">Jurusan :</label>
                            <input type="text" name="jurusan" id="jurusan" class="form-control" placeholder="Jurusan" value="<?php echo $hasil['jurusan'];?>" >
                            <div class="text-danger" id="jurusan_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="tgl_masuk">Tanggal Masuk :</label>
                            <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control" placeholder="Tanggal Masuk" value="<?php echo $hasil['tgl_masuk'];?>" >
                            <div class="text-danger" id="tgl_masuk_invalid"></div>
                        </div>
                        <div class="form-group">
                            <label for="tgl_selesai">Tanggal Selesai :</label>
                            <input type="date" name="tgl_selesai" id="tgl_selesai" class="form-control" placeholder="Tanggal Selesai" value="<?php echo $hasil['tgl_selesai'];?>" >
                            <div class="text-danger" id="tgl_selesai_invalid"></div>
                        </div>
                        <button type="submit" name="pendaftaran" class="btn bg-2 text-light border-0 pr-4 pl-4 pt-2 pb-2">Edit</button>
